# Generated by Django 5.1.1 on 2024-10-04 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('english', 'English'), ('spanish', 'Spanish'), ('english', 'English'), ('spanish', 'Spanish')], default='english', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agent_llm', models.CharField(choices=[('gpt-4o-mini', 'GPT-4o mini'), ('gtp-4o', 'GPT-4o')], default='gpt-4o-mini', max_length=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_item', models.FileField(blank=True, null=True, upload_to='knowledge_files/')),
                ('status_url', models.CharField(choices=[('Indexed', 'Index'), ('Active', 'Active'), ('Errored', 'Error')], default='Indexed', max_length=7)),
                ('knowlegde_files', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='console.knowledgefiles')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='console.customer')),
            ],
        ),
    ]
